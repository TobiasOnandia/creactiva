...
export const PublishButton = () => {
  return (
    <button className="relative cursor-pointer overflow-hidden group px-5 py-2 bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700 rounded-lg font-medium hover:border-neutral-600 transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500/50">
